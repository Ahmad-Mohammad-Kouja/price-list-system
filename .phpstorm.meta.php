...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\auth()->user(), map([
        '' => \App\Domain\Entities\Models\User::class,
    ]));
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/macbook_air_m1/Documents/Repositories/price-list-system/public/storage' => 'string',
...
'auth.guards.user.driver','auth.guards.user.provider','auth.guards.sanctum.driver','auth.guards.sanctum.provider','auth.providers.users.driver',
...
'filesystems.disks.s3.report','filesystems.links./Users/macbook_air_m1/Documents/Repositories/price-list-system/public/storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'cors.allowed_headers','cors.exposed_headers','cors.max_age','cors.supports_credentials','log-viewer.enabled',
...
'log-viewer.strip_extracted_context','log-viewer.per_page_options','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'log-viewer.index','users.auth.login','users.auth.logout',
'users.products.index','users.products.show','storage.local',);
...
'validation.uuid','validation.custom.attribute-name.rule-name','global.response_messages.success','global.response_messages.invalid_credentials','global.response_messages.ok',);
