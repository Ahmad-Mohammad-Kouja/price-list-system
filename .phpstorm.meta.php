...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/macbook_air_m1/Documents/Repositories/price-list-system/public/storage','ide-helper.filename','ide-helper.models_filename',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','log-viewer.enabled','log-viewer.api_only',
...
'log-viewer.per_page_options','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'log-viewer.files.delete-multiple-files','log-viewer.logs','log-viewer.folders.download','log-viewer.files.download','log-viewer.index','storage.local',);
